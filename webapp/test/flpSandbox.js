		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#facturasfacturas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"facturasfacturas-display": {
								"semanticObject": "facturasfacturas",
								"action": "display",
								"description": "lista facturas",
								"title": "lista facturas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=facturas.facturas",
									"url": sap.ui.require.toUrl("facturas/facturas")
								}
							}
						}
					}
